...
<script setup>
  ...
  const items = ref([
    { title: 'Started my journey', description: 'Began learning to code.', expanded: true },
    { title: 'First internship', description: 'Worked on real-world projects.', expanded: true },
